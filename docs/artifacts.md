...
This page provides direct access to the core downloadable deliverables of the fixed-camera machine safety proof of concept (POC).

---

## 1. Safety Research Report (Academic Manuscript)
The manuscript-style academic report detailing our data-collection strategy, sequence model architectures (TCN vs. GRU), operating point trade-offs, and deployment latency budgets:

* **[Download Academic Safety Report (English PDF)](assets/downloads/machine_safety_academic_report.pdf)**: The full technical paper detailing modeling findings and latency budgets.
* **[Download Rapport de Sécurité Machine (French PDF)](assets/downloads/rapport_securite_machine.pdf)**: French translation of the research report for localized compliance and stakeholder review.
